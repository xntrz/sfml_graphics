...
r(static_cast<sf::Uint8>((color & 0xff000000) >> 24)),
g(static_cast<sf::Uint8>((color & 0x00ff0000) >> 16)),
b(static_cast<sf::Uint8>((color & 0x0000ff00) >> 8 )),
a(static_cast<sf::Uint8>((color & 0x000000ff) >> 0 ))
{
