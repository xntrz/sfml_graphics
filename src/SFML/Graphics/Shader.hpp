...
public:
    ...
    ///
    /// \see setUniform(const char*, CurrentTextureType)
    ///
    ////////////////////////////////////////////////////////////
...
public:
    ...
    ///
    ////////////////////////////////////////////////////////////
    void setUniform(const char* name, const Glsl::Vec2& vector);
    ...
    ///
    ////////////////////////////////////////////////////////////
    void setUniform(const char* name, const Glsl::Vec3& vector);
    ...
    ///
    ////////////////////////////////////////////////////////////
    void setUniform(const char* name, const Glsl::Vec4& vector);
    ...
    ///
    ////////////////////////////////////////////////////////////
    void setUniform(const char* name, const Glsl::Ivec2& vector);
    ...
    ///
    ////////////////////////////////////////////////////////////
    void setUniform(const char* name, const Glsl::Ivec3& vector);
    ...
    ///
    ////////////////////////////////////////////////////////////
    void setUniform(const char* name, const Glsl::Ivec4& vector);
    ...
    ///
    ////////////////////////////////////////////////////////////
    void setUniform(const char* name, const Glsl::Bvec2& vector);
    ...
    ///
    ////////////////////////////////////////////////////////////
    void setUniform(const char* name, const Glsl::Bvec3& vector);
    ...
    ///
    ////////////////////////////////////////////////////////////
    void setUniform(const char* name, const Glsl::Bvec4& vector);
    ...
    ///
    ////////////////////////////////////////////////////////////
    void setUniform(const char* name, const Glsl::Mat3& matrix);
    ...
    ///
    ////////////////////////////////////////////////////////////
    void setUniform(const char* name, const Glsl::Mat4& matrix);
    ...
    ///
    ////////////////////////////////////////////////////////////
    void setUniformArray(const char* name, const float* scalarArray, std::size_t length);
    ...
    ///
    ////////////////////////////////////////////////////////////
    void setUniformArray(const char* name, const Glsl::Vec2* vectorArray, std::size_t length);
    ...
    ///
    ////////////////////////////////////////////////////////////
    void setUniformArray(const char* name, const Glsl::Vec3* vectorArray, std::size_t length);
    ...
    ///
    ////////////////////////////////////////////////////////////
    void setUniformArray(const char* name, const Glsl::Vec4* vectorArray, std::size_t length);
    ...
    ///
    ////////////////////////////////////////////////////////////
    void setUniformArray(const char* name, const Glsl::Mat3* matrixArray, std::size_t length);
    ...
    ///
    ////////////////////////////////////////////////////////////
    void setUniformArray(const char* name, const Glsl::Mat4* matrixArray, std::size_t length);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_DEPRECATED void setParameter(const char* name, float x);

    ////////////////////////////////////////////////////////////
    /// \brief Change a 2-components vector parameter of the shader
    ///
    /// \deprecated Use setUniform(const char*, const Glsl::Vec2&) instead.
    ///
    ////////////////////////////////////////////////////////////
    SFML_DEPRECATED void setParameter(const char* name, float x, float y);

    ////////////////////////////////////////////////////////////
    /// \brief Change a 3-components vector parameter of the shader
    ///
    /// \deprecated Use setUniform(const char*, const Glsl::Vec3&) instead.
    ///
    ////////////////////////////////////////////////////////////
    SFML_DEPRECATED void setParameter(const char* name, float x, float y, float z);

    ////////////////////////////////////////////////////////////
    /// \brief Change a 4-components vector parameter of the shader
    ///
    /// \deprecated Use setUniform(const char*, const Glsl::Vec4&) instead.
    ///
    ////////////////////////////////////////////////////////////
    SFML_DEPRECATED void setParameter(const char* name, float x, float y, float z, float w);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_DEPRECATED void setParameter(const char* name, const Vector2f& vector);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_DEPRECATED void setParameter(const char* name, const Vector3f& vector);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_DEPRECATED void setParameter(const char* name, const Color& color);

    ////////////////////////////////////////////////////////////
    /// \brief Change a matrix parameter of the shader
    ///
    /// \deprecated Use setUniform(const char*, const Glsl::Mat4&) instead.
    ///
    ////////////////////////////////////////////////////////////
    SFML_DEPRECATED void setParameter(const char* name, const Transform& transform);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_DEPRECATED void setParameter(const char* name, const Texture& texture);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_DEPRECATED void setParameter(const char* name, CurrentTextureType);
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Set shader attributes to bind before link
    ///
    /// \param attributes   An vector in order of locaation to bind
    ///
    ////////////////////////////////////////////////////////////
...
private:
    ...
    std::vector<std::string>    m_attributes;     ///< Shader attribute location in order to bind before link
};
